...
class ExporterMeta {
    constructor() {
        this.FINAM_DICT_URL = 'https://www.finam.ru/cache/icharts/icharts.js';
        this.FINAM_CATEGORIES = -1;
    }
...
exports.LookupComparator = LookupComparator;
exports.FinamExportError = FinamExportError;
...
var _export = __webpack_require__(/*! ./finam/export */ "./src/finam/export.js");

var finam = _interopRequireWildcard(_export);
...
const logger = new class {
    constructor() {
        this.log = (level, message) => console.log(message, { level });
